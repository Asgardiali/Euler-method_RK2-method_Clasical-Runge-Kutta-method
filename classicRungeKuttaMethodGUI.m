function varargout = classicRungeKuttaMethodGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @classicRungeKuttaMethodGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @classicRungeKuttaMethodGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function classicRungeKuttaMethodGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = classicRungeKuttaMethodGUI_OutputFcn(hObject, eventdata, handles) 
...
[x,y]=RK4s(f,[altSinir,ustSinir],startValue,nValue);
